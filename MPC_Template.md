# Minimum Publishable Contribution (MPC)
...
- **Expected paper length / format:** *e.g. full paper, ~8 pages, double column*
- **Editorial cycle / submission window:** *e.g. rolling, target submission month 10*
...
- *e.g. Quantitative comparison with at least two literature baselines using the same figures of merit.*
- *[Add item]*
- *[Add item]*
...
## 8. Timeline — Milestones, not Tasks
...
- **v1.2** — *date* — *[summarise change]*.

---

*MAIC-Lab — Minimum Publishable Contribution template — internal use*